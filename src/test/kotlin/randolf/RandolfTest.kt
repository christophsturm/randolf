    ...
    override val tests = rootContext<Unit>(transform = skipAndFocus) {
        ...
        context("minimal mode") {
            ...
            test("sets nullable properties to null") {
                expectThat(Randolf(minimal = true).create<NullableFieldsDC>()) {
                    get { string }.isNull()
                    get { int }.isNull()
                    get { long }.isNull()
                    get { double }.isNull()
            ...
            test("sets string properties to empty string") {
                ...
                expectThat(Randolf(minimal = true).create<StringDC>()).get { a }.isEmpty()
            }
            test("sets list properties to empty list") {
                ...
                expectThat(Randolf(minimal = true).create<ListDC>()) {
                    get { list }.isEmpty()
                    get { set }.isEmpty()
            ...
            test("sets map properties to empty maps") {
                ...
                expectThat(Randolf(minimal = true).create<MapDC>()) {
                    get { map }.isEmpty()
                }
            }
